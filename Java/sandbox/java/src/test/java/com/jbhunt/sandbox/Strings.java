...
public class Strings {
    ...
    public void usefulStringMethods() {
        java.lang.String foo = "Hello, World!";

        // changing string
        Assert.assertEquals("1", java.lang.String.valueOf(new Integer(1)));
        Assert.assertEquals("Hello World!", "Hello".concat(" World!"));
        Assert.assertEquals("Hello Tyler!", "Hello World!".replace("World", "Tyler"));
        Assert.assertArrayEquals(new java.lang.String[] { "Hello", " World"}, "Hello, World".split(","));

        // formatting
        Assert.assertEquals("Hello World!", java.lang.String.format("Hello %s", "World!"));
